...
import static org.apache.hadoop.hdds.client.ReplicationFactor.CUSTOM;
...
public abstract class OMKeyRequest extends OMClientRequest {
  ...
  protected List< OmKeyLocationInfo > allocateBlock(ScmClient scmClient,
      ...
      boolean shouldSortDatanodes, Set<String> datacenters, UserInfo userInfo)
      throws IOException {
    ...
    try {
      allocatedBlocks = scmClient.getBlockClient()
          .allocateBlock(scmBlockSize, numBlocks, replicationConfig, serviceID,
              excludeList, clientMachine, datacenters);
